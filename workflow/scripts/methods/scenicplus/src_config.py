...
config_dic["output_data"]["output_fname_dem_html"] = os.path.join(temp_dir, 'o_scenicplus_dem_results.html')
...
config_dic["output_data"]["tf_to_gene_adjacencies"] = os.path.join(temp_dir, 'o_scenicplus_tf_to_gene_adjacencies.tsv')
config_dic["output_data"]["region_to_gene_adjacencies"] = os.path.join(temp_dir, 'o_scenicplus_region_to_gene_adjacencies.tsv')
config_dic["output_data"]["eRegulons_direct"] = os.path.join(temp_dir, 'o_scenicplus_eRegulons_direct.tsv')
config_dic["output_data"]["eRegulons_extended"] = os.path.join(temp_dir, 'o_scenicplus_eRegulons_extended.tsv')
config_dic["output_data"]["AUCell_direct"] = os.path.join(temp_dir, 'o_scenicplus_AUCell_direct.h5mu')
config_dic["output_data"]["AUCell_extended"] = os.path.join(temp_dir, 'o_scenicplus_AUCell_extended.h5mu')
config_dic["output_data"]["scplus_mdata"] = os.path.join(temp_dir, 'o_scenicplus_scplus_mdata.h5mu')
