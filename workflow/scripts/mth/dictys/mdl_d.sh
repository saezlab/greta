...
python workflow/scripts/mth/dictys/filter_expr.py $output_d/expr.tsv.gz $output_d/binlinking.tsv.gz $output_d/expr.tsv.gz && \
echo 'Finished filtering expr.tsv.gz' && \
