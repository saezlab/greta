...
rule index_frags:
    input:
        frags='datasets/pituunpaired/smpl.frags.tsv.gz'
    output:
        index='datasets/pituunpaired/smpl.frags.tsv.gz.tbi'
    params:
        unzip='datasets/pituunpaired/smpl.frags.tsv'
...
rule coembedd_pituunpaired:
    input:
        gex='datasets/pituunpaired/smpl.filtered_feature_bc_matrix.h5',
        celltypes='workflow/scripts/datasets/pituunpaired/celltypes.csv',
        peaks='datasets/pituunpaired/peaks.original.h5',
        frags='datasets/pituunpaired/smpl.frags.tsv.gz'
...
rule pairCells_pituunpaired:
    input:
        exprMat=local('datasets/pituunpaired/exprMat.rds'),
        atacSE=local('datasets/pituunpaired/atac.se.rds'),
        cca=local('datasets/pituunpaired/cca.rds')
    output:
...
rule annotate_pituunpaired:
    input:
        annot='workflow/scripts/datasets/pituunpaired/annot.csv',
        g='gdata/geneids',
